...
const Navbar = () => {
  ...
  const navItems = [
    ...
    // { path: "/dashboard", title: "Dashboard" }, {/* Corrected spelling here */}
  ];
  ...
  <span>JobPortal</span>
        ...
        <div className="text-base text-orange-500 font-medium space-x-5 hidden lg:flex items-center">
          {user ? (
        ...
        <div className="md:hidden block">
          <button onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {isMenuOpen ? <FaXmark className="w-5 h-5 text-orange-500 " /> : <FaBarsStaggered className="w-5 h-5 text-primary" />}
          </button>
        </div>
      </nav>
